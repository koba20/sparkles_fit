...
// Read the SQL file
const sqlFilePath = path.join(__dirname, 'supabase/migrations/20250804000000_create_contact_messages_table.sql');
...
async function runMigration() {
  console.log('🚀 Starting contact messages table migration...');
  ...
  console.log('\n✅ Contact messages table migration completed!');
}
